...
export class SelectOptionService {
  private static readonly PLAYER_ONE: Array<IOption> = [
    ...
    {value: '3', label: 'Nevada'},
    {value: '4', label: 'Oregon'},
    {value: '5', label: 'Washington'},
    {value: '6', label: 'Arizona'},
    {value: '7', label: 'Colorado'},
    {value: '8', label: 'Idaho'},
    {value: '9', label: 'Montana'},
    {value: '10', label: 'Nebraska'},
    {value: '11', label: 'New Mexico'},
    {value: '12', label: 'North Dakota'},
    {value: '13', label: 'Utah'},
    {value: '14', label: 'Wyoming'},
    {value: '15', label: 'Alabama'},
    {value: '16', label: 'Arkansas'},
    ...
    {value: '25', label: 'Oklahoma'},
    {value: '26', label: 'South Dakota'},
    {value: '27', label: 'Texas'},
    {value: '28', label: 'Tennessee'},
    {value: '29', label: 'Wisconsin'},
    {value: '30', label: 'Connecticut'},
    {value: '31', label: 'Delaware'},
    {value: '32', label: 'Florida'},
    {value: '33', label: 'Georgia'},
    {value: '34', label: 'Indiana'},
    {value: '35', label: 'Maine'},
    {value: '36', label: 'Maryland'},
    {value: '37', label: 'Massachusetts'},
    {value: '38', label: 'Michigan'},
    {value: '39', label: 'New Hampshire'},
    {value: '40', label: 'New Jersey'},
    {value: '41', label: 'New York'},
    {value: '42', label: 'North Carolina'},
    {value: '43', label: 'Ohio'},
    {value: '44', label: 'Pennsylvania'},
    {value: '45', label: 'Rhode Island'},
    {value: '46', label: 'South Carolina'},
